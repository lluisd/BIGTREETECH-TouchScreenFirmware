...
| **list files**                | `M20 SD:<folder path>`<br><br>or<br><br>`M20 S <folder path>`<br><br>Examples:<br><br>`M20 SD:`<br>`M20 SD:/test`<br>`M20 S /test`                            | `M20 U:<folder path>`<br><br>or<br><br>`M20 U <folder path>` | `M20`                  |
| **select file**               | `M23 SD:<file path>`<br><br>or<br><br>`M23 S <file path>`<br><br>Examples:<br><br>`M23 SD:cap.gcode`<br>`M23 SD:/test/cap2.gcode`<br>`M23 S /test/cap2.gcode` | `M23 U:<file path>`<br><br>or<br><br>`M23 U <file path>`     | `M23 <file path>`      |
...
| **stop file write**           |                                                                                                                                                               |                                                              | `M29`                  |
| **delete file**               | `M30 SD:<file path>`<br><br>or<br><br>`M30 S <file path>`<br><br>Examples:<br><br>`M30 SD:cap.gcode`<br>`M30 SD:/test/cap2.gcode`<br>`M30 S /test/cap2.gcode` | `M30 U:<file path>`<br><br>or<br><br>`M30 U <file path>`     | `M30 <file path>`      |
