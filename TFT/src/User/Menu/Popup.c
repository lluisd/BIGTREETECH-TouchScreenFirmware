...
{
  strncpy((char *)popup_title, (char *)str, sizeof(popup_title));
}

void _setDialogMsgStr(uint8_t * str)
{
  strncpy((char *)popup_msg, (char *)str, sizeof(popup_msg));
}
...
{
  strncpy((char *)popup_ok, (char *)str, sizeof(popup_ok));
}

void _setDialogCancelTextStr(uint8_t * str)
{
  strncpy((char *)popup_cancel, (char *)str, sizeof(popup_cancel));
}
...
void _setDialogTitleLabel(int16_t index)
{
  ...
  strncpy((char *)popup_title, (char *)tempstr, sizeof(popup_title));
}
...
void _setDialogMsgLabel(int16_t index)
{
  uint8_t tempstr[MAX_LANG_LABEL_LENGTH] = {0};
  loadLabelText(tempstr, index);
  strncpy((char *)popup_msg, (char *)tempstr, sizeof(popup_msg));
}
...
void _setDialogOkTextLabel(int16_t index)
{
  uint8_t tempstr[MAX_LANG_LABEL_LENGTH] = {0};
  loadLabelText(tempstr, index);
  strncpy((char *)popup_ok, (char *)tempstr, sizeof(popup_ok));
}
...
void _setDialogCancelTextLabel(int16_t index)
{
  uint8_t tempstr[MAX_LANG_LABEL_LENGTH] = {0};
  loadLabelText(tempstr, index);
  strncpy((char *)popup_cancel, (char *)tempstr, sizeof(popup_cancel));
}
