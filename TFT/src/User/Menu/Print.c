...
void gocdeIconDraw(void)
{
  ...
  {
    restoreFilenameExtension(i + baseIndex - infoFile.folderCount);  // restore filename extension if filename extension feature is disabled
    ...
    hideFilenameExtension(i + baseIndex - infoFile.folderCount);  // hide filename extension if filename extension feature is disabled
