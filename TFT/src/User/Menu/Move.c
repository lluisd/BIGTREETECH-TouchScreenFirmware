...
void storeMoveCmd(AXIS xyz, int8_t direction)
{
  ...
  storeCmd(xyzMoveCmd[xyz], (infoSettings.inverted_axis[xyz] ? -direction : direction) * moveLenSteps[item_moveLen_index],
...
void menuMove(void)
{
  ...
  #endif
    ;
  if (infoSettings.inverted_axis[X_AXIS] != 1)
