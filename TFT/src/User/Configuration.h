 ...
 * The checksum algorithm used is "CheckSum8 Xor" and it is calculated on the G-code with the applied
 * line number. E.g. "G28" is first enriched with a line number (e.g. "N1 G28") and finally a checksum
 * calculated on that enriched G-code is appended (e.g. "N1 G28*18").
