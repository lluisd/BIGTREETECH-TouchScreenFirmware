...
#define CONFIG_STATUS_COLOR           "status_color:"
...
#define CONFIG_PS_AUTO_SHUTDOWN_TEMP  "ps_auto_shutdown_temperature:"
//-----------------------------Filament Runout Settings (only if connected to TFT controller)
#define CONFIG_RUNOUT                 "fil_runout:"
#define CONFIG_RUNOUT_INVERTED        "fil_runout_inverted:"
...
#define CONFIG_START_GCODE_STATE      "start_gcode_state:"
#define CONFIG_END_GCODE_STATE        "end_gcode_state:"
#define CONFIG_CANCEL_GCODE_STATE     "cancel_gcode_state:"
