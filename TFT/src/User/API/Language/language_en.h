...
#define _LANGUAGE_EN_H_
    ...
    #define STRING_FAN_SPEED_PERCENTAGE   "Fan Speed in Percent"
    ...
    #define STRING_PLR_HOME               "Home after power loss"
    ...
    #define STRING_START_GCODE_ON         "Start Gcode before print"
    #define STRING_END_GCODE_ON           "End Gcode after print"
